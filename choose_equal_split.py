...
with open('../Data/Topcoder1/trainingData.csv', 'rb') as csvfile:
    ...
    with open('../Data/Topcoder1/trainEqual.csv', 'w') as train:
        with open('../Data/Topcoder1/valEqual.csv', 'w') as val:
            for line in data:
